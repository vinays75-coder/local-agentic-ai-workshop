...
| 2    | **Ollama**                           | Runs local LLM models such as Llama locally on your laptop | [Download Ollama](https://ollama.com/download)       | ~5 mins             | After installation run: `ollama pull llama3.2:1b`                         |
